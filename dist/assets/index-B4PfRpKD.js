...
`,Nl=()=>{const e={subtitle:"스마트 농업 현장 문제점 찾아 지원금 지급 공고",manager:"농업지원과",contact:"063-222-2222",period:"2025-06-02~2025-06-30",announcementNumber:"김제시 공고 제2025-626호",content:"'25년 소규모 사업장 방지시설 설치 지원사업 시행(추가) 공고\n\n- 사물인터넷(IoT) 측정기기 부착 지원 -\n\n「대기환경보전법」 제81조의 규정에 따라 추진하는 2025년도 소규모 대기오염 방지시설 설치지원 사업시설지원터넷 (IoT) 측정기기 부착지원」을 아래와 같이 추가로 공고오니 사업 참여 희망 사업장은 공고내용에 따라 신청서를 제출하 여 주시기 바랍니다.\n\n2025년 6월 2일\n\n김 제 시 장",attachmentName:"지원금제안서양식표.hwpx",attachmentSize:"58 kb"};return w.jsxs(ul,{children:[w.jsxs(pl,{children:[w.jsx(fl,{children:w.jsx(Jn,{})}),w.jsx(ml,{children:"지원금 및 세미나"})]}),w.jsx(on,{children:w.jsxs(hl,{children:[w.jsxs(xl,{children:[w.jsx(gl,{children:e.subtitle}),w.jsx(bl,{children:"농업지원과 2025.06.03"})]}),w.jsx(wl,{children:w.jsx(yl,{children:w.jsxs("tbody",{children:[w.jsxs(vl,{children:[w.jsx(kl,{children:"담당부서"}),w.jsx(Sl,{children:e.manager})]}),w.jsxs(vl,{children:[w.jsx(kl,{children:"연락처"}),w.jsx(Sl,{children:e.contact})]}),w.jsxs(vl,{children:[w.jsx(kl,{children:"공시/공고 기간"}),w.jsx(Sl,{children:e.period})]})]})})}),w.jsxs(jl,{children:[w.jsx(zl,{children:e.announcementNumber}),w.jsx(zl,{style:{whiteSpace:"pre-line"},children:e.content})]}),w.jsx(Cl,{children:w.jsxs(_l,{children:[w.jsxs(El,{children:[w.jsx(Pl,{children:"📄"}),w.jsxs(Fl,{children:[e.attachmentName," [",e.attachmentSize,"]"]})]}),w.jsxs(Tl,{children:[w.jsx(Al,{children:"다운로드"}),w.jsx(Al,{children:"미리보기"})]})]})})]})})]})},Il=d.create({baseURL:"https://baekend.onrender.com",headers:{"Content-Type":"application/json"}});Il.interceptors.request.use(e=>{const t=localStorage.getItem("accessToken");return t&&(e.headers.Authorization=`Bearer ${t}`),e},e=>Promise.reject(e));const Ll=n.div`
  min-height: 100vh;
  background-color: #FFEFD5;
  padding: 5px 0;
`,Dl=n.div`
