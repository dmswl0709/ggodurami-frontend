...
const Home = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(TopBar, {}), _jsx(Header, {}), _jsx(Container, { children: _jsxs(MainWrapper, { children: [_jsx(MapWrapper, { children: _jsx(MapContainer, { children: _jsx(MapSection, { reports: reportsData, onMarkerClick: handleMarkerClick, selectedReport: selectedReport, onReportBoxClick: handleReportBoxClick }) }) }), _jsx(AlertBanner, {}), _jsx(NewsSection, {})] }) })] }));
};
